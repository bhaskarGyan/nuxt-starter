...
const _sfc_main$2 = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./_nuxt/error-component.ce9a628e.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div class="flex text-red-900 p-10">Nuxt3 with InlineCss True</div></div>`);
}
